...
<p>bonjous et niquer vos mére les pute !<br />

    <body>
        <thml>
            <h1>Titre super important</h1>
            <h2>titre important</h2>
            <h3>titre un peut moin important(sous titreh)</h3>
...
<p>
    ...
    <a href="#cryxa">La cuisine</a><br />
    <a href="#cryxa">Les rollers</a><br />
    <a href="#cryxa">Le tir à l'arc</a><br />
</p>
...
<p>... (on veut pas de .zip) ...</p>
<p>... (ok je men blc mec) ...</p>
<p>... (cryxa je suis pas gay) ...</p>

<h2 id="rollers">Les rollers</h2>

<p>... (truq fais en htmlby cryxa) ...</p>

<h2 id="arc">Le tir à l'arc</h2>
<p>Bonjour. Vous souhaitez visiter <a href="https://cryxa.com">lebestserveur</a> ?<br /> C'est un bon site ;o)</p>
<p>
    Voici une photo de Tundara enfaite non :<br />
    <img src="imaginea_fleville_OSD55664427-20925.webp" alt="Photo de magasin" />
    <figure>
...
<a href="http://site.com" title="Quelque part par ici"></a>
...
<p { background-color: rgba(255, 0, 0, 0.5); /* Fond rouge à moitié transparent */ } p { background-color: rgb(255,0,0); /* Pour les navigateurs anciens */ background-color: rgba(255,0,0,0.5); /* Pour les navigateurs plus récents */ } p { background-color:
    rgba(255, 0, 0, 0.5); /* Fond rouge à moitié transparent */ } p { background-color: rgb(255,0,0); /* Pour les navigateurs anciens */ background-color: rgba(255,0,0,0.5); /* Pour les navigateurs plus récents */ } a:visited /* Quand le visiteur a déjà vu
    la page concernée */ { color: #AAA; /* Appliquer une couleur grise */ } p { border-radius: 30px / 11px; } a:hover { } <!DOCTYPE html>
    <html>
    <tête>
        <meta charset="utf-8" />
        <style>
